...
const Skills = () => {
  ...
  return (
    <>
      <div className="SkillHolder w-12/12 font-poppins bg-supportBlue p-5 flex flex-col justify-center items-center">
        <div>
          <div className="flex flex-col lg:flex-row lg:gap-x-5">
            ...
            <h1 className="text-center text-4xl lg:text-5xl font-bold text-white h-16">
        ...
        <div className="flex gap-y-5 gap-x-5 flex-wrap justify-center items-center mt-10">
          {data.map((val) => (
            <>
              <div className="cardHolder p-5 w-40 lg:w-52 bg-cardBlue shadow-xl flex flex-col  justify-center text-white font-medium items-center font-sans">

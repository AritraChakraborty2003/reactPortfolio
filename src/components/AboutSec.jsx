            ...
            <>
              ...
              <div className="rightPart p-5 w-[100vw] lg:w-[50vw] flex flex-col justify-start mt-5  ">
                <p className="text-[4vmin] font-medium">
                  Name:{" "}
                  <span className="text-[4vmin] font-bold">{val.name}</span>
                </p>
                <p className="text-[4vmin] mt-1 text-supportBlue font-bold font-poppins">
                  {val.desig}
                </p>
                <p className="mt-2 text-[4vmin] font-normal ">{val.descr}</p>

                <p className="text-[4vmin] text-supportBlue font-bold mt-3 font-poppins">
                  Location:&nbsp;
                  <span className="text-[4vmin]  text-black font-normal font-poppins">
                    {val.location}
                  </span>
                </p>
                <p>
                  <span className="text-lg mt-2 text-supportBlue font-bold font-poppins">
                    Email:&nbsp;
                  </span>
                  <span className="text-md mt-10 text-black font-normal font-poppins">
                    {" "}
                    {val.email}
                  </span>
                </p>

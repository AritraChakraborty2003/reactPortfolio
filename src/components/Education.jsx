  ...
  return (
    <div id="education" className="aboutArea w-[100vw] bg-darkwhite pb-6">
      ...
      <div className="cardHolder flex flex-col justify-center items-center gap-y-8">
        {data.map((val) => (
          <div className="cardBox w-[97vw] lg:w-[75vw] p-3 bg-white  flex gap-x-4  ">
            <div className="mt-4 imgBox h-[20vmin] w-[35vmin] lg:h-[26vmin] lg:w-[60vmin] bg-white flex justify-center items-center ml-2">
